...
SEED_SCORECARDS = {
    ...
    'sales': [
        # METRICS (21)
        ('METRICS', 'New Leads',                   'DC', '',  0,  '1784',   '600',  '228', '323', '', '', ''),
        ('METRICS', 'New Patients',                'KH', '',  1,  '83',     '100',  '4',   '28',  '', '', ''),
        ('METRICS', 'NEW ROF',                     'KH', '',  2,  '47',     '68',   '3',   '20',  '', '', ''),
        ('METRICS', 'Survey Completed',            '',   '',  3,  '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'DComp Starts',                'DC', '',  4,  '23',     '38',   '4',   '6',   '', '', ''),
        ('METRICS', 'DComp PIF',                   'DC', '$', 5,  '83870',  '',     '11220','39243','','',''),
        ('METRICS', 'DComp Half Pay',              'DC', '$', 6,  '26768',  '',     '3300', '',   '', '', ''),
        ('METRICS', 'DComp Start Revenue',         'DC', '$', 7,  '110638', '',     '14520','39243','','',''),
        ('METRICS', 'Close Rate %',                'DC', '%', 8,  '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'Average Order Value',         'DC', '$', 9,  '4810',   '4500', '3956','6541', '', '', ''),
        ('METRICS', 'NON MRI new patients',        'KH', '',  10, '23',     '50',   '',    '',    '', '', ''),
        ('METRICS', 'RED MRI CONVERSION',          'KH', '%', 11, '30',     '60',   '',    '',    '', '', ''),
        ('METRICS', 'ROF Kaplan',                  'DC', '',  12, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'ROF Dudum',                   'DC', '',  13, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'ROF Tong',                    'DC', '',  14, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'Starts Kaplan',               'DC', '',  15, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'Starts Dudum',                'DC', '',  16, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'Starts Tong',                 'DC', '',  17, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'ROF Conversion % Kaplan',     'DC', '%', 18, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'ROF Conversion % Dudum',      'DC', '%', 19, '',       '',     '',    '',    '', '', ''),
        ('METRICS', 'ROF Conversion % Tong',       'DC', '%', 20, '',       '',     '',    '',    '', '', ''),
        # CONTINUITY PROGRAM (8)
        ('CONTINUITY PROGRAM', 'Continuity Offers',           '', '',  0, '',  '20', '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'New Continuity Members',      '', '',  1, '',  '',   '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'Continuity Close Rate',       '', '%', 2, '',  '',   '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'Contract Amount',             '', '$', 3, '',  '',   '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'Average Cont. Contract Amount','','$', 4, '',  '',   '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'Total Continuity Members',    '', '',  5, '',  '',   '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'Cancelled Continuity Members','', '',  6, '',  '',   '', '', '', '', ''),
        ('CONTINUITY PROGRAM', 'Churn Rate %',                '', '%', 7, '',  '',   '', '', '', '', ''),
        # MARISA SETTER METRICS (7)
        ('MARISA SETTER METRICS', 'Marisa - Outbound Calls',  '', '',  0, '899', '', '49',  '351', '', '', ''),
        ('MARISA SETTER METRICS', 'Marisa - Connects',        '', '',  1, '139', '', '10',  '58',  '', '', ''),
        ('MARISA SETTER METRICS', 'Marisa - Connect Rate %',  '', '%', 2, '15',  '20','20', '17',  '', '', ''),
        ('MARISA SETTER METRICS', 'Marisa - Offers',          '', '',  3, '85',  '', '5',   '24',  '', '', ''),
        ('MARISA SETTER METRICS', 'Marisa - Offer Rate %',    '', '%', 4, '61',  '75','50', '41',  '', '', ''),
        ('MARISA SETTER METRICS', 'Marisa - Setter Closes',   '', '',  5, '46',  '', '3',   '7',   '', '', ''),
        ('MARISA SETTER METRICS', 'Marisa - Close Rate %',    '', '%', 6, '54',  '60','60', '29',  '', '', ''),
        # STHEPHANNY SETTER METRICS (7)
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Outbound Dials', '', '',  0, '', '', '115', '523', '', '', ''),
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Connects',       '', '',  1, '', '', '',    '',    '', '', ''),
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Connect Rate %', '', '%', 2, '', '', '',    '',    '', '', ''),
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Offers',         '', '',  3, '', '', '',    '',    '', '', ''),
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Offer Rate %',   '', '%', 4, '', '', '',    '',    '', '', ''),
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Setter Closes',  '', '',  5, '', '', '',    '',    '', '', ''),
        ('STHEPHANNY SETTER METRICS', 'Sthephanny - Close Rate %',   '', '%', 6, '', '', '',    '',    '', '', ''),
    ],
}
